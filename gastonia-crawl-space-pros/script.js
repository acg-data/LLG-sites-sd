(() => {
  ...
  const buildEstimateMailto = (values) => {
    ...
    const body = [
      'Gastonia Crawl Space Pros Estimate Request',
      '',
    ...
    return `mailto:info@gastoniacrawlspacepros.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  };
