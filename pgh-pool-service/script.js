(() => {
  ...
  const buildQuoteMailto = (values) => {
    const subject = 'Free Pool Estimate Request';
    const body = [
      'PGH Pool Service Estimate Request',
      '',
    ...
    return `mailto:service@pghpoolservice.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  };
